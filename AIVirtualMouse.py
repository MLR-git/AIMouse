...
while True:
    ...
    if len(landmarkList) != 0:
        ...
        #Index finger only = movement mode
        if fingerTips[1] == 1 and fingerTips[2] == 0:
            #Convert coordinates from default resolution to actual resolution
    ...
    #Index + Middle fingers = clicking mode
